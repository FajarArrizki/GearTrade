...
export default function PromptManager() {
  ...
  return (
    <>
      <div className="w-full overflow-hidden flex flex-col p-4" style={{ height: 'calc(100vh - 72px)', minHeight: 0, maxHeight: 'none', boxSizing: 'border-box' }}>
        <div className="flex flex-col lg:flex-row gap-4 overflow-hidden flex-1" style={{ height: 'calc(100vh - 72px - 2rem)', minHeight: 0, maxHeight: 'none' }}>
        {/* LEFT COLUMN - Template Selection + Edit Area */}
        <div className="flex-1 flex flex-col gap-4 overflow-hidden min-w-0" style={{ height: '100%', minHeight: 0, maxHeight: 'none' }}>
          <Card className="flex-1 flex flex-col overflow-hidden" style={{ height: '100%', minHeight: 0, maxHeight: 'none' }}>
            <CardHeader className="flex-shrink-0">
              <CardTitle className="text-base">Prompt Template Editor</CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col gap-4 flex-1 min-h-0 overflow-hidden" style={{ height: '100%', maxHeight: 'none', minHeight: 0 }}>
              ...
              <div className="flex-1 flex flex-col overflow-hidden min-h-0">
                <label className="text-xs uppercase text-muted-foreground flex-shrink-0">Template Text</label>
                <textarea
                  className="flex-1 w-full rounded-md border bg-background p-3 font-mono text-sm leading-relaxed focus:outline-none focus:ring-1 focus:ring-ring min-h-0 resize-none"
        ...
        <Card className="flex flex-col w-full lg:w-[40rem] flex-shrink-0 overflow-hidden" style={{ height: '100%', minHeight: 0, maxHeight: 'none' }}>
          <CardHeader className="flex-shrink-0">
            <CardTitle className="text-base">Account Prompt Bindings</CardTitle>
          </CardHeader>
          <CardContent className="flex-1 flex flex-col gap-6 min-h-0 overflow-hidden" style={{ height: '100%', maxHeight: 'none', minHeight: 0 }}>
            {/* Bindings Table */}
