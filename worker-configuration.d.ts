/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a56ece0f0a99aef5109fec77443c72d6)
...
declare namespace Cloudflare {
	interface Env {
		...
		HYPERLIQUID_WALLET_ADDRESS: "0xef63654b60b30a3f4a894ce974d96506c98d0871";
		MCP_SCRAPER_USE_SAVE_SHORTCUT: "true";
		MCP_SCRAPER_HEADLESS: "true";
		MCP_SCRAPER_WINDOW_WIDTH: "1400";
		MCP_SCRAPER_WINDOW_HEIGHT: "1400";
		ARBITRUM_RPC_URL: string;
		PRIVATE_KEY: string;
		AGENT_PRIVATE_KEY: string;
		SESSION_REGISTRY_ADDRESS: string;
		TRADING_VAULT_ADDRESS: string;
		MOCK_USDC_ADDRESS: string;
		HYPERLIQUID_PRIVATE_KEY: string;
		HYPERLIQUID_BASE_URL: string;
		HYPERLIQUID_API_URL: string;
		HYPERLIQUID_TESTNET_RPC_URL: string;
		HYPERLIQUID_ACCOUNT_ADDRESS: string;
		DEPLOYER_ADDRESS: string;
		TREASURY_ADDRESS: string;
		ADMIN_ADDRESS: string;
		UPGRADER_ADDRESS: string;
		AGENT_ADDRESS: string;
		ARBISCAN_API_KEY: string;
		FOUNDRY_PROFILE: string;
		FOUNDRY_RPC_URL: string;
		FOUNDRY_CHAIN_ID: string;
		AI_PROVIDER: string;
		MODEL_ID: string;
		OPENROUTER_API_KEY: string;
		COINMARKETCAP_API_KEY: string;
		BENCHMARK_LOG: string;
		HYPERLIQUID_WALLET_API_KEY: string;
		AGENT: DurableObjectNamespace /* TradingAgent */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TEST_MODE" | "HYPERLIQUID_RPC_URL" | "HYPERLIQUID_WALLET_ADDRESS" | "MCP_SCRAPER_USE_SAVE_SHORTCUT" | "MCP_SCRAPER_HEADLESS" | "MCP_SCRAPER_WINDOW_WIDTH" | "MCP_SCRAPER_WINDOW_HEIGHT" | "ARBITRUM_RPC_URL" | "PRIVATE_KEY" | "AGENT_PRIVATE_KEY" | "SESSION_REGISTRY_ADDRESS" | "TRADING_VAULT_ADDRESS" | "MOCK_USDC_ADDRESS" | "HYPERLIQUID_PRIVATE_KEY" | "HYPERLIQUID_BASE_URL" | "HYPERLIQUID_API_URL" | "HYPERLIQUID_TESTNET_RPC_URL" | "HYPERLIQUID_ACCOUNT_ADDRESS" | "DEPLOYER_ADDRESS" | "TREASURY_ADDRESS" | "ADMIN_ADDRESS" | "UPGRADER_ADDRESS" | "AGENT_ADDRESS" | "ARBISCAN_API_KEY" | "FOUNDRY_PROFILE" | "FOUNDRY_RPC_URL" | "FOUNDRY_CHAIN_ID" | "AI_PROVIDER" | "MODEL_ID" | "OPENROUTER_API_KEY" | "COINMARKETCAP_API_KEY" | "BENCHMARK_LOG" | "HYPERLIQUID_WALLET_API_KEY">> {}
}
